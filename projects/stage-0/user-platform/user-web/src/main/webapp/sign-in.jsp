...
<body>
	<div class="container">
		<form class="form-signin" action="/register" method="post">
			...
			<label for="inputPassword1" class="sr-only">Password</label> <input
				type="password" id="inputPassword1" name="password" class="form-control"
				placeholder="请输入密码" required>
			<label for="inputPhoneNumber" class="sr-only">Password</label> <input
				type="phone" id="inputPhoneNumber" name="phoneNumber" class="form-control"
